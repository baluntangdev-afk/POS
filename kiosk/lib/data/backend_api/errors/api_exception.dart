...
/// Typed failure of a call to the external orders service (webhook-receiver).
/// Raised by sources using [ApiCall.guard], so repositories and features can
/// branch on the backend's `error` slug / HTTP status without touching Dio.
