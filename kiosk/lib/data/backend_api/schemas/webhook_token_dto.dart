...
class WebhookTokenDto with WebhookTokenDtoMappable {
  const WebhookTokenDto({required this.merchantId, required this.token, required this.exp, this.merchantName});
  ...
  /// Human-readable merchant name the backend resolved for [merchantId], when
  /// it sent one.
