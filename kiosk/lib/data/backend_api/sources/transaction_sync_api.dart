...
/// The orders service's side of transaction sync.
class TransactionSyncApi with ApiCall {
  ...
  /// since the interceptor only attaches an already-cached token, it doesn't
  ...
  Future<TransactionSyncResultDto> pushBatch({
    ...
    return TransactionSyncResultDto.fromMap(response.data as Map<String, dynamic>);
  });
}
