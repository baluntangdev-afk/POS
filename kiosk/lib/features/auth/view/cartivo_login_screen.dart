...
import 'cartivo_login_view.dart';

class CartivoLoginScreen extends StatelessWidget {
  const CartivoLoginScreen({super.key});
          ...
          if (isPortrait) {
            return Column(
              children: [
                ...
                Expanded(child: Container(color: Colors.white, child: const CartivoLoginView())),
              ],
            );
          }
      ...
      content = Column(
        ...
        children: [
          Container(
            ...
            child: Center(child: Assets.images.cartivoLogo.image(height: 48, fit: BoxFit.contain)),
          ),
          ...
          Text(
            ...
            style: TextStyle(
              color: Colors.white,
              fontSize: r.value<double>(kiosk: 26, tablet: 21, phone: 17),
