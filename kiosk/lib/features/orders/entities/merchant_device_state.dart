...
/// Local view of this device's registration with the webhook-receiver.
///
...
class MerchantDeviceState {
  ...
  /// The Kiosk ID the persisted registration belongs to. Used to decide
  /// whether a Kiosk ID change requires re-registration.
