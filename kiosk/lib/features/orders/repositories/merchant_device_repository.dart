...
final merchantDeviceRepositoryProvider = Provider<MerchantDeviceRepository>((ref) {
...
abstract class MerchantDeviceRepository {
  ...
  /// tagged with the [storeId] (Kiosk ID) it was registered against.
  Future<DeviceRegistrationDto> registerDevice(RegisterDeviceRequest request, {required String storeId});

  Future<String?> currentDeviceId();

  /// The Kiosk ID the persisted registration belongs to, if any.
...
class MerchantDeviceRepositoryImpl implements MerchantDeviceRepository {
  const MerchantDeviceRepositoryImpl(this._api, this._storage, this._deviceTokenStorage);
  ...
  @override
  Future<DeviceRegistrationDto> registerDevice(RegisterDeviceRequest request, {required String storeId}) async {
