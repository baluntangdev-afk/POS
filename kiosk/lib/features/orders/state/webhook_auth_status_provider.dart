...
/// `POST /auth/token`) so the UI can toast it. [OrdersFeedNotifier] and the
/// Kiosk ID save flow report failures here; a root-level `ref.listen` in
/// `app.dart` shows the toast.
///
...
final webhookAuthStatusProvider = NotifierProvider<WebhookAuthStatusNotifier, WebhookAuthFailure?>(
