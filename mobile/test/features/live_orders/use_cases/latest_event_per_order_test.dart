...
void main() {
  ...
  test('keeps the latest event even when it appears before an older one in the input', () {
    final updated = _event(
      orderId: 'ord_1',
      updatedAt: DateTime.utc(2026, 1, 1, 11),
      type: OrderEventType.updated,
    ...
    final result = latestEventPerOrder([updated, created]);

    expect(result, hasLength(1));
    expect(result.single.type, OrderEventType.updated);
  });
